...
/*******************************************/
/**        Tap Sensor Configuration       **/
/*******************************************/
/*
  *  The Sparkfun MA8452Q Accelerometer has a number of functions including "tap" detection 
  *  We can set the sensitivity of the tap detection from 0 to 10 (scales from 0 to 127) with 10 being most sensitive
  *  The sensor can also return acceleration values for x,y, and z though we don't use them in this sketch
*/
#define TAP_SENSOR_DEFUALT_SENSITIVITY 5
#define TAP_SENSOR_DEFUALT_DEBOUNCE_MINNUTES 1
...
/**  Sensor Settings  **/
#define TOF_SENSOR_TIMEOUT 500                      // Forces TofSensor::measure() to stop after waiting SENSOR_TIMEOUT ms for the SFEVL53L1X checkForDataReady() function to return a nonzero value.  
...
#define TOF_DEFAULT_ZONE_MODE 0 // 'default'
